...
public class AprovarOrcamentoUseCase {
    ...
    public AprovarOrcamentoUseCase(OrcamentoRepositoryGateway repository, OutboxEventSender outboxEventSender) {
        this(repository, outboxEventSender, Clock.systemUTC());
    }

    AprovarOrcamentoUseCase(OrcamentoRepositoryGateway repository, OutboxEventSender outboxEventSender, Clock clock) {
                ...
                .thenCompose(optional -> {
                    ...
                    if (orcamento.status() != StatusOrcamento.GERADO) {
                        throw new BusinessException(
                                ...
                                "Somente orcamentos gerados podem ser aprovados.");
                    }
